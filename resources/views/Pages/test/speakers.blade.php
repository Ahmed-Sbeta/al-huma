...
<!-- Mirrored from zcube.in/eventes/speakers.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Nov 2024 15:28:29 GMT -->
<head>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <main>
            ...
            <!-- team-area-end -->
			<!-- slider-area -->
            <section id="parallax" class="slider-area slider-bg second-slider-bg slider-bg3 slider-bg4  d-flex align-items-center justify-content-center fix" style="background-image:url(img/counter_form_bg.jpg)">
                    ...
                    <div class="single-slider">
                        <div class="container">
                            <div class="row">
								...
								<div class="col-lg-4">
									<div class="booking-form  mb-50 mt-50 align-items-center justify-content-center wow fadeInLeft" data-animation="fadeInLeft" data-delay=".2s">
										...
										<form>
											...
											<div class="form-outer">
												...
												<select id="select">
												   <option selected="selected"><span class="grey_color">Select your seat</span></option>
												   <option>one</option>  
												   <option>two</option>  
												   <option>three</option>  
												   <option>four</option>  
...
<!-- Mirrored from zcube.in/eventes/speakers.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Nov 2024 15:28:30 GMT -->
</html>
